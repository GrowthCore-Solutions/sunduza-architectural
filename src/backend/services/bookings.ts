...
export async function createBooking(
  ...
  // Lead upsert and booking creation share one transaction so the aggregate
  // lead row and the booking row commit together. The callback form gives us
  // a `tx` client whose every write is part of the same atomic unit.
